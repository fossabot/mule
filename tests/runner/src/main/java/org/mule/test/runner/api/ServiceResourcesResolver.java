...
public class ServiceResourcesResolver {
   ...
   *
   * @param serviceUrlClassification {@link PluginUrlClassification} to be resolved
  ...
  public ArtifactUrlClassification resolveServiceResourcesFor(ArtifactUrlClassification serviceUrlClassification) {
    ...
    try (URLClassLoader classLoader = new URLClassLoader(serviceUrlClassification.getUrls().toArray(new URL[0]), null)) {
      ...
      //new MavenClassLoaderModelLoader().load();

      muleServiceModel.getClassLoaderModelLoaderDescriptor().ifPresent(
      ...
      //return new PluginUrlClassification(serviceUrlClassification.getName(), serviceUrlClassification.getUrls(),
      //                                   serviceUrlClassification.getExportClasses(),
      //                                   serviceUrlClassification.getPluginDependencies(), exportPackages, exportResources,
